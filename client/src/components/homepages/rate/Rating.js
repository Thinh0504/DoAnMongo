  ...
  return (
    <article>
      ...
      <div class="flex items-center mb-1">
        ...
        <h3 class="ml-2 text-sm font-semibold text-gray-900 dark:text-black">
          Thinking to buy another one!
        </h3>
      </div>
      <footer class="mb-5 text-sm text-gray-700 dark:text-gray-600">
        <p>
          Reviewed in the United Kingdom on{" "}
          <time datetime="2017-03-03 19:00">March 3, 2017</time>
        </p>
      </footer>
      <p class="mb-2 font-light text-gray-700 dark:text-gray-600">
      ...
      <aside>
        <p class="mt-1 text-xs text-gray-900 dark:text-gray-800">
